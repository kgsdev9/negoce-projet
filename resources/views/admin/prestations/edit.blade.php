  ...
  <div class="content">
    ...
    <div class="card mb-4">
      ...
      <div class="card-header">
        <h3 class="mb-0">Edition de la  Prestation  </h3>
      </div>
      <!-- Card body -->
        <form action="{{route('prestation.update', $ressource->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            @if ($errors->any())
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="title" id="example3cols1Input" placeholder="Nom de la prestation" value="{{$ressource->title }}">
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="categorie" id="example3cols1Input" placeholder="Nom de la categorie" value="{{$ressource->categorie }}">
            </div>
          </div>
          ...
          <div class="col-md-12">
           ...
           <textarea name="description" id="summernote"  cols="30" rows="10" class="form-control">{{$ressource->description }}</textarea>
            </div>
          </div>
