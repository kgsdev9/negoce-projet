<body>
    ...
    <div class="navbar-area navbar-style-two is-sticky">
        <div class="dibiz-responsive-nav">
            <div class="container">
                <div class="dibiz-responsive-menu mean-container"><div class="mean-bar"><a href="#nav" class="meanmenu-reveal" style="background:;color:;right:0;left:auto;"><span><span><span></span></span></span></a><nav class="mean-nav">
                        <ul class="navbar-nav" style="display: none;">
                            <li class="nav-item"><a href="#" class="nav-link active">Home <i class="bx bx-chevron-down"></i></a>
                                <ul class="dropdown-menu" style="display: none;">
                                    ...
                                    <li class="nav-item"><a href="index-3.html" class="nav-link active">Home Demo - 3</a></li>

                                    <li class="nav-item"><a href="index-4.html" class="nav-link">Home Demo - 4</a></li>

                                    <li class="nav-item"><a href="index-5.html" class="nav-link">Home Demo - 5</a></li>

                                    <li class="nav-item"><a href="index-6.html" class="nav-link">Home Demo - 6</a></li>

                                    <li class="nav-item"><a href="index-7.html" class="nav-link">Home Demo - 7</a></li>

                                    <li class="nav-item"><a href="index-8.html" class="nav-link">Home Demo - 8</a></li>

                                    <li class="nav-item"><a href="index-9.html" class="nav-link">Home Demo - 9</a></li>

                                    <li class="nav-item"><a href="index-10.html" class="nav-link">Home Demo - 10</a></li>

                                    <li class="nav-item"><a href="index-11.html" class="nav-link">Home Demo - 11</a></li>

                                    <li class="nav-item"><a href="index-12.html" class="nav-link">Home Demo - 12</a></li>
                                </ul>
                            ...
                            <li class="nav-item"><a href="#" class="nav-link">About <i class="bx bx-chevron-down"></i></a>
                                <ul class="dropdown-menu" style="display: none;">
                                    ...
                                    <li class="nav-item"><a href="about-us-3.html" class="nav-link">About Us 3</a></li>

                                    <li class="nav-item"><a href="about-us-4.html" class="nav-link">About Us 4</a></li>
                            ...
                            <li class="nav-item"><a href="#" class="nav-link">Services <i class="bx bx-chevron-down"></i></a>
                                <ul class="dropdown-menu" style="display: none;">
                                    <li class="nav-item"><a href="services-1.html" class="nav-link">Services One</a></li>

                                    <li class="nav-item"><a href="services-2.html" class="nav-link">Services Two</a></li>

                                    <li class="nav-item"><a href="services-3.html" class="nav-link">Services Three</a></li>

                                    <li class="nav-item"><a href="services-4.html" class="nav-link">Services Four</a></li>

                                    <li class="nav-item"><a href="services-5.html" class="nav-link">Services Five</a></li>

                                    <li class="nav-item"><a href="single-services.html" class="nav-link">Services Details</a></li>

                                    <li class="nav-item"><a href="single-services-2.html" class="nav-link">Services Details Two</a></li>

                                    <li class="nav-item"><a href="single-services-3.html" class="nav-link">Services Details Three</a></li>
                                </ul>
                            <a class="mean-expand" href="#" style="font-size: 18px">+</a></li>
                            ...
                            <li class="nav-item"><a href="#" class="nav-link">Pages <i class="bx bx-chevron-down"></i></a>
                                <ul class="dropdown-menu" style="display: none;">
                                    ...
                                    <li class="nav-item"><a href="#" class="nav-link">Shop <i class="bx bx-chevron-right"></i></a>
                                        <ul class="dropdown-menu" style="display: none;">
                                            <li class="nav-item"><a href="products-list.html" class="nav-link">Products List</a></li>
                                    ...
                                    <li class="nav-item"><a href="contact-2.html" class="nav-link">Contact Style Two</a></li>

                                    <li class="nav-item"><a href="contact-3.html" class="nav-link">Contact Style Three</a></li>
                                </ul>
                            <a class="mean-expand" href="#" style="font-size: 18px">+</a></li>
                            ...
                            <li class="nav-item"><a href="#" class="nav-link">Portfolio <i class="bx bx-chevron-down"></i></a>
                                <ul class="dropdown-menu" style="display: none;">
                                    <li class="nav-item"><a href="#" class="nav-link">Portfolio Style One <i class="bx bx-chevron-right"></i></a>
                                        <ul class="dropdown-menu" style="display: none;">
                                            <li class="nav-item"><a href="portfolio-1.html" class="nav-link">Portfolio 2 Columns</a></li>

                                            <li class="nav-item"><a href="portfolio-2.html" class="nav-link">Portfolio 3 Columns</a></li>

                                            <li class="nav-item"><a href="portfolio-3.html" class="nav-link">Portfolio No Space</a></li>
                                        </ul>
                                    <a class="mean-expand" href="#" style="font-size: 18px">+</a></li>

                                    <li class="nav-item"><a href="#" class="nav-link">Portfolio Style Two <i class="bx bx-chevron-right"></i></a>
                                        <ul class="dropdown-menu" style="display: none;">
                                            <li class="nav-item"><a href="portfolio-4.html" class="nav-link">Portfolio 2 Columns</a></li>

                                            <li class="nav-item"><a href="portfolio-5.html" class="nav-link">Portfolio 3 Columns</a></li>

                                            <li class="nav-item"><a href="portfolio-6.html" class="nav-link">Portfolio No Space</a></li>
                                        </ul>
                                    <a class="mean-expand" href="#" style="font-size: 18px">+</a></li>
                                    ...
                                    <li class="nav-item"><a href="case-studies-details.html" class="nav-link">Case Studies Details</a></li>

                                    <li class="nav-item"><a href="projects.html" class="nav-link">Projects</a></li>

                                    <li class="nav-item"><a href="projects-details.html" class="nav-link">Projects Details</a></li>
                                </ul>
                            <a class="mean-expand" href="#" style="font-size: 18px">+</a></li>
                            ...
                            <li class="nav-item"><a href="#" class="nav-link">Blog <i class="bx bx-chevron-down"></i></a>
                                <ul class="dropdown-menu" style="display: none;">
                                    ...
                                    <li class="nav-item"><a href="blog-style-2.html" class="nav-link">Blog Style Two</a></li>

                                    <li class="nav-item"><a href="blog-style-3.html" class="nav-link">Blog Style Three</a></li>
                                    ...
                                    <li class="nav-item"><a href="#" class="nav-link">Single Post <i class="bx bx-chevron-right"></i></a>
                                        <ul class="dropdown-menu" style="display: none;">
                                            ...
                                            <li class="nav-item"><a href="blog-details-2.html" class="nav-link">Blog Details Two</a></li>

                                            <li class="nav-item"><a href="blog-details-3.html" class="nav-link">Blog Details Three</a></li>
                                        </ul>
                                    <a class="mean-expand" href="#" style="font-size: 18px">+</a></li>
                                </ul>
                            <a class="mean-expand" href="#" style="font-size: 18px">+</a></li>

                            <li class="nav-item mean-last"><a href="contact.html" class="nav-link">Contact</a></li>
                        </ul>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="logo">
                        <a href="index-3.html" class="d-inline-block"><img src="assets/img/logo.png" alt="image"></a>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="banner-content">
                        <span class="sub-title wow animate__ animate__fadeInLeft" data-wow-delay="00ms" data-wow-duration="1000ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 0ms; animation-name: fadeInLeft;">Digital Marketing</span>
                        <h1 class="wow animate__ animate__fadeInLeft" data-wow-delay="10ms" data-wow-duration="1000ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 10ms; animation-name: fadeInLeft;">Digital Agency with Excellence Service</h1>
                        <p class="wow animate__ animate__fadeInLeft" data-wow-delay="200ms" data-wow-duration="1000ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 200ms; animation-name: fadeInLeft;">We have created a cloud based tool to do your all boring tasks related to data analysis and decesion making based on the nature of data!</p>
                        <div class="btn-box wow animate__ animate__fadeInLeft animated" data-wow-delay="300ms" data-wow-duration="1000ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 300ms; animation-name: fadeInLeft;">
                            <a href="about-us-1.html" class="default-btn">Learn More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="banner-image">
                        <img src="assets/img/banner-img4.png" class="wow animate__ animate__fadeInUp animated" alt="image" data-wow-delay="00ms" data-wow-duration="1000ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 0ms; animation-name: fadeInUp;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="feedback-content">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1053px, 0px, 0px); transition: all 0s ease 0s; width: 2457px;"><div class="owl-item cloned" style="width: 351px;"><div class="single-feedback-item">
                            ...
                            </div></div><div class="owl-item cloned" style="width: 351px;"><div class="single-feedback-item">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                            ...
                            </div></div><div class="owl-item" style="width: 351px;"><div class="single-feedback-item">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                            ...
                            </div></div><div class="owl-item animated owl-animated-in fadeIn active" style="width: 351px;"><div class="single-feedback-item">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                            ...
                            </div></div><div class="owl-item animated owl-animated-in fadeIn" style="width: 351px;"><div class="single-feedback-item">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                            ...
                            </div></div><div class="owl-item animated owl-animated-in fadeIn cloned" style="width: 351px;"><div class="single-feedback-item">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                            ...
                            </div></div></div></div><div class="owl-nav disabled"><button type="button" role="presentation" class="owl-prev"><i class="flaticon-back"></i></button><button type="button" role="presentation" class="owl-next"><i class="flaticon-chevron"></i></button></div><div class="owl-dots"><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot active"><span></span></button><button role="button" class="owl-dot"><span></span></button></div></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-portfolio-box">
                        <a href="single-portfolio.html" class="image d-block">
                            <img src="assets/img/portfolio/portfolio-img1.jpg" alt="image">
                        </a>

                        <div class="content">
                            <h3><a href="single-portfolio.html">Movie Recommendation</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-portfolio-box">
                        ...
                        <div class="content">
                            <h3><a href="single-portfolio.html">Customer Segmentation</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-portfolio-box">
                        ...
                        <div class="content">
                            <h3><a href="single-portfolio.html">Data Analysis</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-portfolio-box">
                        ...
                        <div class="content">
                            <h3><a href="single-portfolio.html">Detection Project</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-portfolio-box">
                        ...
                        <div class="content">
                            <h3><a href="single-portfolio.html">Data Scientist</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-portfolio-box">
                        ...
                        <div class="content">
                            <h3><a href="single-portfolio.html">Benefits Research</a></h3>
    ...
    <section class="team-area-two ptb-100">
        <div class="container">
            ...
            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1524px, 0px, 0px); transition: all 0.25s ease 0s; width: 4572px;"><div class="owl-item cloned" style="width: 351px; margin-right: 30px;"><div class="single-team-member">
                    <div class="image">
                ...
                </div></div><div class="owl-item cloned" style="width: 351px; margin-right: 30px;"><div class="single-team-member">
                    <div class="image">
                ...
                </div></div><div class="owl-item" style="width: 351px; margin-right: 30px;"><div class="single-team-member">
                    <div class="image">
                ...
                </div></div><div class="owl-item active" style="width: 351px; margin-right: 30px;"><div class="single-team-member">
                    <div class="image">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="content">
                            <h3><a href="single-blog-1.html">How to make the perfect morning coffee, according to the Science</a></h3>
                            <div class="d-flex align-items-center">
                                <img src="assets/img/user1.jpg" alt="image">
                                <div class="info">
                                    <h5>David Smith</h5>
        ...
        <div class="container">
            <div class="subscribe-content">
                ...
                <form class="newsletter-form" data-bs-toggle="validator" novalidate="true">
                    ...
                    <button type="submit" class="default-btn disabled" style="pointer-events: all; cursor: pointer;">Subscribe Now</button>
    ...
    <footer class="footer-area">
        <div class="container">
            ...
            <div class="footer-bottom-area">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <p>© Dibiz is Proudly Owned by <a href="https://envytheme.com/" target="_blank">EnvyTheme</a></p>
                    </div>
    ...
    <script src="assets/js/main.js"></script><a href="https://themeforest.net/checkout/from_item/27446681?license=regular&amp;support=bundle_6month&amp;_ga=2.224557722.1657781501.1653794352-1356931366.1645330919" target="_blank" class="buy-now-btn"><img src="assets/img/envato.png" alt="envato">Buy Now</a>
